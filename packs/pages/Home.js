    ...
    <>
      ...
      <section>
        <ul className="uk-subnav filter">
          <li className="sub-filter on-active"><p>All</p></li>
          <li className="sub-filter"><p>Banking</p></li>
          <li className="sub-filter"><p>Telco</p></li>
          <li className="sub-filter"><p>Mobile Money</p></li>
        </ul>
        <div className="wrapper will-grow">
          <form className="uk-search uk-search-default max-365">
            ...
            <input className="uk-search-input bg-white picotext h-48"
                   type="search"
          ...
          <section className="code-head">
            <div className="space-between-groups flex-wrap">
              <p className="ff-bold smalltext no-wrap mb-1 mx-auto ml-0">
                All Countries
              </p>
            ...
            <a href="/directory" className="ff-medium co-blue mt-3 microtext d-none fit-content mx-auto"
               id="view">View
              more</a>
          </section>
        </div>
      ...
      <section className="wrapper will-grow d-flx gsm-section bg-lightblue">
        <div className="mb-2 width-100-pc max-474">
          ...
          <p className="lh-31 mb-2h">
            ...
            money, buy
            airtime, request money, check your account balance, and do more with your bank and mobile money accounts. It
            leverages
            USSD automation technology to give you more control of your money. No need to remember different USSD codes,
            switch from
            bank app to fintech app or biller to biller ever again. Best part is - it works offline.
          </p>
          <a href="https://stax.onelink.me/nR0j/ussddirectory" target="_blank"><img className="google-play mr-2 mb-2"
                                                                                    src="/uploads/play.png"
                                                                                    alt="Google-play" /></a>
        </div>
      ...
      <section className="wrapper will-grow negate-bottom">
        <h4 className="co-deepblack mb-5 h2 mt-5h">
          USSD blog
        </h4>
        ...
        <div className="col-lg-2 col-md-5 home-blog-post-link order-last order-lg-first order-md-6">
          <a href="https://blog.ussd.directory" className="ff-semibold microtext co-blue mt-5 d-blk tx-r">View all</a>
        </div>
      </section>
    </>
  )
